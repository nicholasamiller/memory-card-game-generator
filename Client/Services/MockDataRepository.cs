...
太冷了(tài lěng le) too cold";
            ...
            var cardsData = MemoryCardGameGenerator.Model.CardsData.LoadSpecsFromString(testCardsData);
            var dtos = cardsData.Select(d => new CardDataDto() { Chinese = d.ChineseCardSpec.chineseCharacter, Pinyin = d.ChineseCardSpec.pinyin, English = d.EnglishCardSpec.englishWord });
